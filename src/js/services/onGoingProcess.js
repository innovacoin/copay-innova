...
angular.module('copayApp.services').service('ongoingProcess', function($log, $timeout, $filter, lodash, $ionicLoading, gettext, platformInfo) {
  var root = {};
  ...
  var processNames = {
    ...
    'buyingBitcoin': gettext('Buying Innova...'),
    'sellingBitcoin': gettext('Selling Innova...'),

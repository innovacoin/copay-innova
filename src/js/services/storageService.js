...
angular.module('copayApp.services')
  .service('storageService', function(logHeader, fileStorageService, localStorageService, sjcl, $log, lodash, platformInfo, $timeout) {
    ...
    root.setBitpayAccount = function(network, data, cb) {
      ...
      root.getBitpayAccounts(network, function(err, allAccounts) {
        ...
        $log.info('Storing Innova accounts with new account:' + data.email);
        storage.set('bitpayAccounts-v2-' + network, allAccounts, cb);
      });
    };

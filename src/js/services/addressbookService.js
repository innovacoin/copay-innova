...
angular.module('copayApp.services').service('addressbookService', function($log, bitcore, bitcoreCash, storageService, lodash) {
  var root = {};
  ...
  var getNetwork = function(address) {
    ...
    try {
      ...
      $log.warn('No valid innova address.');
  ...
  root.add = function(entry, cb) {
    ...
    if (lodash.isEmpty(network)) return cb('Not valid innova address');

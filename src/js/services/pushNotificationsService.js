'use strict';
angular.module('copayApp.services').service('pushNotificationsService', function pushNotificationsService($log, $state, $ionicHistory, sjcl, platformInfo, lodash, appConfigService, profileService, configService) {
  var root = {};
